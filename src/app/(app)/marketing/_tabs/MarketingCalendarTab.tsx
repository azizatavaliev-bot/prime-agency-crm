      ...
      <Section
        ...
        right={
          <div className="flex gap-2">
            <Link href={`/marketing?tab=calendar&y=${prev.y}&m=${prev.m}`} className="btn-ghost !px-3 !py-1.5 !text-xs">
              ← Пред.
            </Link>
            <Link href="/marketing?tab=calendar" className="btn-ghost !px-3 !py-1.5 !text-xs">
              Сегодня
            </Link>
            <Link href={`/marketing?tab=calendar&y=${next.y}&m=${next.m}`} className="btn-ghost !px-3 !py-1.5 !text-xs">
              След. →
            </Link>
          </div>
        }
