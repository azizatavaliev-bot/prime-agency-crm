...
import { PageHeader, Table, Stat, Section, MiniStat } from "@/components/ui";
  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={
          showProfit
            ? `${monthLabel(month)} · расходы вычитаются из доли владельца`
            : `${monthLabel(month)} · учёт расходов агентства`
        }
        right={
          <div className="flex flex-wrap gap-2">
            ...
            <FormModal
              ...
              title="Новый расход"
              icon={<Plus size={16} />}
              hint="Расход уменьшает вашу чистую прибыль за месяц (доля команды и резерв считаются от чека и не трогаются). Отметьте «ежемесячный» — и одним кликом перенесёте его в следующий месяц."
            >
