...
import { Table, Stat, Section } from "@/components/ui";
...
/**
 * Вкладка «Аналитика» внутри «Финансы и счета».
 *
 * Раньше это была отдельная страница /analytics — ещё один пункт меню рядом
 * с финансами, хотя данные те же самые (оплаты, расходы, клиенты). Владелец
 * держал в голове два места вместо одного. Доступ прежний — только владелец
 * (`SUPER_ADMIN`): раньше страница дополнительно требовала requireOwner()
 * отдельно от финансов, теперь эту же границу держит вызывающая FinancePage.
 */
  ...
  return (
    <div>
      <div className="mb-5 flex flex-wrap items-center justify-between gap-2">
        <div className="text-sm text-muted">Сводка за 12 месяцев · выручка включает оплаты клиентов и прочие приходы</div>
