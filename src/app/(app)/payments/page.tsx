  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle={`${monthLabel(month)} · клик по строке открывает карточку платежа`}
        right={
          <FormModal
            label="Новый платёж"
            title="Новый платёж"
            icon={<Plus size={16} />}
            hint="Платёж привязывается к клиенту и исполнителю. Сумма сразу делится: доля исполнителя → резерв на развитие → чистая прибыль владельца. Дата «план» создаёт напоминание за 3 дня."
          >
            <PaymentForm
              clients={clients}
